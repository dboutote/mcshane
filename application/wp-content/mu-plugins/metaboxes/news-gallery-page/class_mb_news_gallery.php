...
/**
 * MetaBox_NewsGallery Metabox Class
 *
 * Add a taxonomy drop down
 *
 */
class MetaBox_NewsGallery {
	...
	public function __construct()
	{
		...
		add_action( 'wp_ajax_setup_news_terms', array($this, 'get_taxonomy_terms') );
	}
	...
	public static function register_scripts()
	{
		wp_register_script(
			'ng_scripts',
			MU_URL  . 'metaboxes/news-gallery-page/js/script.js',
			array( 'jquery' ),
			1.0,
			true
		);
	...
	protected function set_meta_box_args()
	{
		...
		$args = array(
			...
			'meta_box_title' => __( 'News Gallery Settings' ),
			'meta_box_default' => '',
	 ...
	 */
	 public function save_meta($post_id, $post, $update)
	 {
		...
		if( !isset($_POST['page_template']) || 'page-templates/news-gallery.php' !== $_POST['page_template'] ){
			return $post_id;
		}
...
$MetaBox_NewsGallery = new MetaBox_NewsGallery();